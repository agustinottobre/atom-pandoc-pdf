...
export default class PandocPdfView {
  ...
  constructor(editor) {
    ...
    this.element.querySelector('[data-id="open-defaults"]').style.display = 'none'

    this.element.querySelector('[data-id="show-files"]').addEventListener(
      'click', (e) => this.processor.showFiles())
    this.element.querySelector('[data-id="show-files"]').style.display = 'none'
    ...
    this.element.querySelector('[data-id="show-settings"]').style.display = 'none'

    this.element.querySelector('[data-id="show-help"]').addEventListener(
      'click', (e) => this.showHelp())
    this.element.querySelector('[data-id="show-help"]').style.display = 'none'
